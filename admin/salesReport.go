...
func SalesReportExcel(c *gin.Context) {
	...
	// =============== save exel file into local ============need to cahnge the path
	excelPath := "/home/abuaibak/Desktop/final_attempt/sales_report.xlsx"
...
func SalesReportPDF(c *gin.Context) {
	...
	// ============== save doc into local ================  need to cahnge the path
	pdfPath := "/home/abuaibak/Desktop/final_attempt/sales_report.pdf"
